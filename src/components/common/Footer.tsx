          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <Typography.SubText className="text-gray-600 leading-relaxed">
                Your dedicated AI-powered digital employee for audit. It is owned and operated by Ordit Technologies Limited.
              </Typography.SubText>
            </div>

            {/* Contact Information */}
            <div className="space-y-4">
              <Typography.H4 className="text-gray-900 font-semibold">
                Contact Information
              </Typography.H4>
