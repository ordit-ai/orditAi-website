    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F8FAFF] via-white to-[#EFF4FF]">
      ...
      <div className="pt-[8%] pb-[6em]">
        <div className="w-[85%] mx-auto text-center space-y-8">
          <div className="inline-block px-6 py-2 bg-primary/10 rounded-full">
            <Typography.SubText className="text-primary font-medium tracking-wide">
              About OrditAI
            </Typography.SubText>
          </div>
          ...
          <Typography.Text className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            We're on a mission to revolutionize how businesses operate by creating intelligent digital workers 
            that complement human capabilities and drive unprecedented growth.
          </Typography.Text>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-block px-4 py-2 bg-green-100 rounded-lg">
              <Typography.SubText className="text-green-700 font-semibold">
                Our Mission
              </Typography.SubText>
            </div>
            ...
            <div className="space-y-4">
              <Typography.Text className="text-lg text-gray-600 leading-relaxed">
                ...
                digital workers. We design and train intelligent agents capable of complementing humans at work, 
                driving efficiency and increased output without increasing headcount.
              </Typography.Text>
              
              <Typography.Text className="text-lg text-gray-600 leading-relaxed">
                We envisage a future where humans and digital agents collaborate seamlessly, enabling entrepreneurs 
                to build viable businesses, optimize resources, and maximize their return on investment.
              </Typography.Text>
            </div>
          </div>
      ...
      <div className="w-[85%] mx-auto mb-16">
        <div className="text-center mb-12">
          <Typography.SubText className="text-primary font-medium tracking-wide mb-4">
            Our Values
          </Typography.SubText>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            ...
            <Typography.SubText className="text-gray-600 leading-relaxed">
              We constantly push the boundaries of what's possible with AI, creating cutting-edge solutions 
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            ...
            <Typography.SubText className="text-gray-600 leading-relaxed">
              We believe in the power of humans and AI working together, complementing each other's strengths 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <Typography.SubText className="text-lg text-white/90 leading-relaxed">
                Our digital workers are designed to handle complex tasks, automate repetitive processes, 
                and provide intelligent insights that drive business growth and operational excellence.
              </Typography.SubText>
          ...
          <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-xl border border-gray-100/50 hover:shadow-2xl transition-all duration-500">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <Typography.Text className="text-xl text-gray-700 leading-relaxed font-medium">
                We envision a world where every business, regardless of size, can leverage the power of AI 
                to optimize their operations, enhance productivity, and achieve sustainable growth.
              </Typography.Text>
              
              <Typography.Text className="text-lg text-gray-600 leading-relaxed">
                Our digital workers will become the backbone of modern business operations, handling complex tasks, 
                making data-driven decisions, and working seamlessly alongside human teams to create unprecedented value.
              </Typography.Text>
